...
(function () {
    ...
    var aa, ba = this || self, ca = /^[\w+/_-]+[=]{0,2}$/, ea = null;
    var fa = function () {
    }, ha = function (a) {
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    var f = window, u = document, Ma = navigator, Na = u.currentScript && u.currentScript.src, Oa = function (a, b) {
        var c = f[a];
        f[a] = void 0 === c ? b : c;
        return f[a]
    }, Pa = function (a, b) {
        ...
        if (b && Wa(b, "id") != a) {
            Ka("TAGGING", 1);
            for (var c = 1; c < document.all[a].length; c++) if (Wa(document.all[a][c], "id") == a) return document.all[a][c]
        }
        return b
    }, Wa = function (a, b) {
    ...
    var pb = function (a, b, c, d, e, g) {
        ...
        a:{
            ...
            if ("auto" === p) {
                ...
                k = !1
            } else p && "none" != p && (m += "; domain=" + p), k = !ob(p, t) && mb(m, a, l)
        }
        return k
    };
    ...
    function jb(a, b) {
        for (var c = [], d = ib(a), e = 0; e < d.length; e++) {
            ...
            if (!b || -1 !== b.indexOf(h)) {
                var k = g.shift();
                k && (k = k.split("-"), c.push({id: g.join("."), zb: 1 * k[0] || 1, Sa: 1 * k[1] || 1}))
            }
        }
        return c
    }

    var rb = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/, sb = /(^|\.)doubleclick\.net$/i, ob = function (a, b) {
    ...
    var Pb = [], Qb = [], Rb = [], Sb = [], Tb = [], Ub = {}, Vb, Wb, Xb, Yb = function (a, b) {
            var c = {};
            c["function"] = "__" + a;
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    ...
    var Cc = Bc, Dc = null, Ec = null, Fc = null, Gc = "//www.googletagmanager.com/a?id=" + yc.m + "&cv=1", Hc = {},
        Ic = {}, Jc = function () {
            var a = zc.sequence || 0;
            zc.sequence = a + 1;
            return a
    ...
    var Pc = function () {
        ...
        var a = Rc;
        if (void 0 === a) return "";
        var b = La("GTM"), c = La("TAGGING");
        return [Zc, Sc[a] ? "" : "&es=1", $c[a], b ? "&u=" + b : "", c ? "&ut=" + c : "", Pc(), Tc, "&z=0"].join("")
    }, ad = function () {
        return [Gc, "&v=3&t=t", "&pid=" + na(), "&rv=" + yc.sb].join("")
    }, bd = "0.005000" >
        Math.random(), Zc = ad(), cd = function () {
        Zc = ad()
    }, Sc = {}, Tc = "", Rc = void 0, $c = {}, Uc = {}, Qc = void 0, Vc = function (a, b) {
        var c = 0, d = 0;
        return {
            Tf: function () {
                if (c < a) return !1;
    ...
    var vd = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/), wd = {
        cl: ["ecl"],
    ...
    var Ad = function (a) {
        ...
        return function (h) {
            ...
            if (b) {
                var n;
                if (n = m) a:{
                    if (0 > la(c, k)) if (l && 0 < l.length) for (var p = 0; p < l.length; p++) {
                        if (0 >
                            la(c, l[p])) {
                            Ka("GTM", 11);
                            n = !1;
    ...
    function Qd(a) {
        ...
        if (!zc._li && f.performance && f.performance.timing) {
            var b = f.performance.timing.navigationStart, c = ja(md.get("gtm.start")) ? md.get("gtm.start") : 0;
            zc._li = {cst: a(c - b), cbt: a(Ec - b)}
        }
    };
    var Wd = !1, Xd = function () {
    ...
    var Zd = function (a) {
        ...
        if (f[b]) f.hasOwnProperty(b) || Ka("GTM", 12); else {
            var c = function () {
                c.q = c.q || [];
                c.q.push(arguments)
            };
    ...
    function ke(a, b, c, d) {
        ...
        if (h && h.length) {
            var k = h[0];
            g = ke(k.index, {J: g, O: 1 === k.yd ? b.terminate : g, terminate: b.terminate}, c, d)
        }
        return g
    }
    ...
    function le(a, b, c, d) {
        function e() {
            if (g[dc.Ee]) k(); else {
                var v = ac(g, c, []), y = Md(c.id, Number(g[dc.qd]), v[dc.Fe]), x = !1;
        ...
        var g = Sb[a], h = b.J, k = b.O, l = b.terminate;
        if (c.sc(g)) return null;
        var m = $b(g[dc.rd], c, []);
        if (m && m.length) {
            var n = m[0], p = ke(n.index, {J: h, O: k, terminate: l}, c, d);
            if (!p) return null;
            h = p;
            k = 2 === n.yd ? l : p
        }
        if (g[dc.od] || g[dc.Ge]) {
            var t = g[dc.od] ? Tb : c.sg, q = h, r = k;
            if (!t[a]) {
                e = ya(e);
                var w = me(a, t, e);
                h = w.J;
    ...
    function pe(a, b) {
        ...
        for (var c = [], d = 0; d < Sb.length; d++) if (a.Ra[d]) {
            var e = Sb[d];
            var g = b.add();
            try {
                var h = ke(d, {J: g, O: g, terminate: g}, a, d);
                h ? c.push({$d: d, b: bc(e), yf: h}) : (qe(d, a), g())
            } catch (l) {
                g()
            }
        }
    ...
    function qe(a, b) {
        if (!bd) return;
        var c = function (d) {
            var e = b.sc(Sb[d]) ? "3" : "4", g = $b(Sb[d][dc.pd], b, []);
    ...
    var te = !1, ue = function (a, b, c, d, e) {
        if ("gtm.js" == b) {
            if (te) return !1;
            te = !0
        }
        ...
        td(a, "gtm");
        var h = {
            id: a, name: b, sc: Ad(c), Ra: [], sg: [], Md: function (p) {
                Ka("GTM", 6);
                je(p)
            }
        };
        ...
        if (!k) return k;
        for (var l = {
            __cl: !0, __ecl: !0, __ehl: !0, __evl: !0,
            __fsl: !0, __hl: !0, __jel: !0, __lcl: !0, __sdl: !0, __tl: !0, __ytl: !0
        }, m = 0; m < h.Ra.length; m++) if (h.Ra[m]) {
            var n = Sb[m];
    ...
    var G = {Pb: "event_callback", Rb: "event_timeout"};
    ...
    };var De = null, Ee = {}, Fe = {}, Ge, He = function (a, b) {
        var c = {event: a};
    ...
    var Ie = function () {
        ...
        if (void 0 === Fe[a.id]) {
            ...
            switch (a.prefix) {
                case "UA":
                    b = ve("gtagua", {trackingId: a.id});
                    break;
                case "AW":
                    b = ve("gtagaw", {conversionId: a});
                    break;
                case "DC":
                    b = ve("gtagfl", {targetId: a.id});
                    break;
                case "GF":
                    b = ve("gtaggf", {conversionId: a});
                    break;
                case "G":
                    b = ve("get", {trackingId: a.id, isAutoTag: !0});
                    break;
                case "HA":
                    b = ve("gtagha", {conversionId: a});
                    break;
                default:
                    return
            }
            if (!Ge) {
                var c = Yb("v", {name: "send_to", dataLayerVersion: 2});
                Pb.push(c);
    ...
    var Me = {
        config: function (a) {
            ...
            if (ia(b) && !(3 < a.length)) {
                ...
                var d = He(b, c);
                var e;
                var g = c, h = ld("gtag.fields.send_to", 2);
                ia(h) || (h = G.oa);
                var k = g && g[h];
    ...
    var ef = function () {
            ...
            if (null != b) {
                ...
                try {
                    if (ha(b)) try {
                        ...
                        if (ia(l[0])) {
                            var m =
                                l[0].split("."), n = m.pop(), p = l.slice(1), t = ld(m.join("."), 2);
        ...
        var a = Oa("dataLayer", []), b = Oa("google_tag_manager", {});
        ...
        a.push = function () {
            ...
            var g = c.apply(a, d);
            Ze.push.apply(Ze, d);
            if (300 < this.length) for (Ka("GTM", 4); 300 < this.length;) this.shift();
    ...
    function Vf(a, b) {
        ...
        1 < d && (c += "-" + d);
        return c
    };var Wf = ["1"], Xf = {}, ag = function (a, b, c, d) {
        var e = Yf(a);
    ...
    var kg = function () {
        var a = Oa("google_tag_data", {}), b = a.gl;
        b && b.decorators || (b = {decorators: []}, a.gl = b);
        return b
    };
    var lg = /(.*?)\*(.*?)\*(.*)/, mg = /^https?:\/\/([^\/]*?)\.?cdn\.ampproject\.org\/?(.*)/,
        ng = /^(?:www\.|m\.|amp\.)+/, og = /([^?#]+)(\?[^#]*)?(#.*)?/, pg = /(.*?)(^|&)_gl=([^&]*)&?(.*)/,
        rg = function (a) {
            var b = [], c;
            for (c in a) if (a.hasOwnProperty(c)) {
                var d = a[c];
            ...
            return function (a) {
                var b = hb(f.location.href), c = b.search.replace("?", ""), d = db(c, "_gl", !0) || "";
                a.query = sg(d) || {};
            ...
            try {
                if (a) {
                    ...
                    if (h && "1" === h[1]) {
                        var k = h[3], l;
                        a:{
                            for (var m = h[2], n = 0; n < b; ++n) if (m === qg(k, n)) {
                                l = !0;
                                break a
                            }
                            l = !1
    ...
    var xg = function (a) {
        ...
        var a = u.location.hostname, b = mg.exec(u.referrer);
        if (!b) return !1;
        var c = b[2], d = b[1], e = "";
        if (c) {
            var g = c.split("/"), h = g[1];
    ...
    var Cg = {};
    var Dg = /^\w+$/, Eg = /^[\w-]+$/, Fg = /^~?[\w-]+$/, Gg = {aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha"};
    ...
    var Jg = function () {
        var a = hb(f.location.href), b = gb(a, "query", !1, void 0, "gclid"), c = gb(a, "query", !1, void 0, "gclsrc"),
    ...
    function Kg(a, b, c) {
        ...
        b = b || {};
        var e = Hg(b.prefix), g = b.domain || "auto", h = b.path || "/", k = void 0 == b.Nd ? 7776E3 : b.Nd;
        c = c || wa();
    ...
    function Sg(a) {
        var b = hb(f.location.href), c = gb(b, "host", !1);
        if (c && c.match(Rg)) {
    ...
    var Wg;
    if (3 === yc.sb.length) Wg = "g"; else {
        var Xg = "G";
        Xg = "g";
        Wg = Xg
    }
    var Yg = {"": "n", UA: "u", AW: "a", DC: "d", G: "e", GF: "f", HA: "h", GTM: Wg}, Zg = function (a) {
        var b = yc.m.split("-"), c = b[0].toUpperCase(), d = Yg[c] || "i", e = a && "GTM" === c ? b[1] : "", g;
        if (3 === yc.sb.length) {
            var h = void 0;
            h = h || (Oe() ? "s" : "o");
            g = "2" + (h || "w")
    ...
    var $g = function (a) {
        ...
        if (5 === b.M) c = "1"; else if (6 === b.M) c = b.Ic; else return !1;
        $g(c) && a("qty", c);
        $g(b.vb) && a("cost", b.vb);
        $g(b.transactionId) && a("ord", b.transactionId);
        return !0
    }, bh = encodeURIComponent, ch = function (a, b) {
        function c(n, p, t) {
            g.hasOwnProperty(n) || (p += "", e += ";" + n + "=" +
                (t ? p : bh(p)))
        }

        var d = a.kc, e = a.protocol;
    ...
    var eh = function (a) {
        var b = "/pagead/conversion/" + dh(a.conversion_id) + "/?", c = dh(JSON.stringify(a.conversion_data)),
        ...
        if (a.conversionLinkerEnabled) {
            ...
            if (e && e.length) for (var g = 0; g < e.length; g++) d += "&gclgf=" + dh(e[g])
        }
        Ta(d, a.onSuccess, a.onFailure)
    }, dh = function (a) {
        return null === a || void 0 === a || 0 === String(a).length ? "" : encodeURIComponent(String(a))
    };
    var fh = !!f.MutationObserver, gh = void 0, hh = function (a) {
        if (!gh) {
            var b = function () {
                var c = u.body;
    ...
    var zh = f.clearTimeout, Ah = f.setTimeout, H = function (a, b, c) {
        if (Oe()) {
            b && z(b)
    ...
    var Gh = function (a, b) {
            ...
            var e = {prefix: a, path: b, domain: c, Nd: d}, g = Jg();
            Kg(g, e);
            Qg(e)
            ...
            for (var m = Hg(b), n = 0; n < a.length; ++n) {
                ...
                if (void 0 !== Gg[p]) {
                    var t = Lg(p, m), q = k[t];
                    if (q) {
                        var r = Math.min(Mg(q), wa()), w;
                        b:{
                            for (var v = r, y = ib(t, u.cookie), x = 0; x < y.length; ++x) if (Mg(y[x]) > v) {
                                w = !0;
                                break b
                            }
                            w = !1
    ...
    var Sh = Jf.Uf;
    var Th = new pa, Uh = function (a, b) {
        function c(h) {
            var k = hb(h), l = gb(k, "protocol"), m = gb(k, "host", !0), n = gb(k, "port"),
        ...
        if (a.any_of && ka(c)) {
            for (var d = 0; d < c.length; d++) if (Vh({"function": a["function"], arg0: b, arg1: c[d]})) return !0;
            return !1
        }
        switch (a["function"]) {
            case "_cn":
    ...
    var Yh = {}, Zh = encodeURI, M = encodeURIComponent, $h = Ta;
    var ai = function (a, b) {
        if (!a) return !1;
        var c = gb(hb(a), "host");
        if (!c) return !1;
    ...
    var gj = window, hj = document, ij = function (a) {
        ...
        for (var d = ib("AMP_TOKEN", hj.cookie, !0), e = 0; e < d.length; e++) if ("$OPT_OUT" == d[e]) return !0;
    ...
    Y.a.gtagha = ["google"], function () {
        ...
        function e(h) {
            var k = Fc, l = h.vtp_gtmOnSuccess, m = h.vtp_gtmOnFailure,
                n = h.vtp_conversionId, p = n.containerId, t = function (A) {
                    return nd(A, p, n.id)
                }, q = !1 !== t(G.Fa), r = t(G.Ea) || t(G.F), w = t(G.N), v = t(G.U);
            if (k === G.aa) {
                var y = t(G.Ha) || {};
    ...
    Y.a.gtagaw = ["google"], function () {
        var a = !1, b = [], c = ["aw", "dc"], d = function (m) {
            var n = K("google_trackConversion"), p = m.gtm_onFailure;
            ...
            if (Oe()) {
                ...
                ka(n) || (n = [n]);
                for (var q =
                    0; q < n.length; q++) 1 > q && Mc(m.da[0], m.da[1], n[q], {be: p, zg: t})
            }
        }, k = function (m) {
            if (m) {
            ...
            var n = m.vtp_conversionId, p = Fc, t = p == G.aa, q = n.da[0], r = n.da[1], w = void 0 !== r,
                v = n.containerId, y = w ? n.id : void 0, x = function (X) {
                    return nd(X, v, y)
                }, A = !1 !== x(G.Fa), B = x(G.Ea) || x(G.F), C = x(G.N), E = x(G.U);
            if (t) {
                var F = x(G.Ha) || {};
                ...
                if (w) {
                    var Q = x(G.Xb), W = x(G.Vb), V = x(G.Wb), S = x(G.ld);
                    h(n, Q, W || V, S)
                }
            }
            var P = !1 === x(G.ad) || !1 === x(G.Ia);
            if (!t || !w && !P) if (!0 === x(G.bd) && (w = !1), !1 !== x(G.S) || w) {
                var N = {
                ...
                !w && x(G.T) && (N.google_gtag_event_data = {items: x(G.T), value: x(G.ca)});
                if (w && "purchase" == p) {
                    x(G.Nb) && (N.google_conversion_merchant_id = x(G.Nb), N.google_basket_feed_country = x(G.dd), N.google_basket_feed_language = x(G.ed), N.google_basket_discount = x(G.cd), N.google_basket_transaction_type = p, N.google_disable_merchant_reported_conversions =
                        !0 === x(G.gd), Oe() && (N.google_disable_merchant_reported_conversions = !0));
                    var J = k(x(G.T));
    ...
    Y.a.get = ["google"], function () {
        ...
        (function (b) {
            ...
            if (b.vtp_isAutoTag) {
                ...
                var q = b.vtp_settings, r = q.eventParameters, w = q.userProperties;
                Ha(bi(b.vtp_eventParameters, "name", "value"), r);
                Ha(bi(b.vtp_userProperties, "name", "value"), w);
                r[G.nb] = w;
                var v = String(b.vtp_eventName), y = b.vtp_allowSystemNames;
    ...
    Y.a.gtagfl = [], function () {
        ...
        function c(e, g, h) {
            var k = /^u([1-9]\d?|100)$/, l = e(G.ke) || {}, m = rd(g, h), n = {}, p = {};
        ...
        (function (e) {
            ...
            if (k) {
                ...
                }, m = !1 !== l(G.Fa), n = l(G.Ea) || l(G.F), p = l(G.N), t = l(G.U), q = l(G.ne), r = 3 === Kc();
                if (Fc === G.aa) {
                    var w = l(G.Ha) || {}, v = l(G.ie), y = void 0 === v ? !0 : !!v;
                    ...
                    var x = {}, A = l(G.me);
                    if (Ga(A)) for (var B in A) if (A.hasOwnProperty(B)) {
                        var C = A[B];
                        void 0 !== C && null !== C && (x[B] = C)
                    }
                    var E = "";
                    if (5 === k.M || 6 === k.M) E = b(M, l);
                    var F = c(l, k.containerId, k.ae), Q = !0 === l(G.de);
                    if (Oe() && Q) {
                        Q = !1
                    }
                    var W = {
    ...
    Y.a.gtaggf = ["google"], function () {
        ...
        (function (c) {
            ...
            var d = Fc, e = c.vtp_gtmOnSuccess, g = c.vtp_gtmOnFailure, h = c.vtp_conversionId, k = h.da[0],
                l = h.containerId, m = function (x) {
                    return nd(x, l, h.id)
                }, n = !1 !== m(G.Fa), p = m(G.Ea) || m(G.F), t = m(G.N), q = m(G.U);
            if (d === G.aa) n && Kh(p, void 0, t, q), z(e); else {
                var r = {conversion_id: k, onFailure: g, onSuccess: e, conversionLinkerEnabled: n, cookiePrefix: p};
                if ("purchase" === d) {
                    var w = a.test(Ch()), v = {
                        partner_id: k,
                        trip_type: m(G.Be),
    ...
    Y.a.gtagua = ["google"], function () {
        var a, b = {
            ...
            h = function (r, w, v, y) {
                if (void 0 !== v) if (g[w] && (v = ta(v)), "anonymize_ip" != w || v || (v = void 0), 1 === r) y[k(w)] = v; else if (ia(r)) y[r] = v; else for (var x in r) r.hasOwnProperty(x) && void 0 !== v[x] && (y[r[x]] = v[x])
            }, k = function (r) {
                ...
                if (Ga(P)) for (var N in P) if (P.hasOwnProperty(N) && /^(dimension|metric)\d+$/.test(N) && void 0 != P[N]) {
                ...
                0 <= la(["view_item",
                    "view_item_list", "view_promotion", "view_search_results"], U) && l(x, "nonInteraction", !0);
                ...
                var S = null, P = Fc, N = A(x.qe);
                "purchase" == P || "refund" == P ? S = {
                    action: P,
                    La: y(),
                    Aa: v(B)
                } : "add_to_cart" == P ? S = {action: "add", Aa: v(B)} : "remove_from_cart" == P ? S = {
                    action: "remove",
                    Aa: v(B)
                } : "view_item" == P ? S = {
                    action: "detail",
                    ...
                    action: "checkout",
                    Aa: v(B),
                    La: {step: "begin_checkout" == P ? 1 : A(x.jd), option: A(x.hd)}
                } : "set_checkout_option" == P && (S = {action: "checkout_option", La: {step: A(x.jd), option: A(x.hd)}});
                S && (S.Kg = A(x.na));
                return S
            }, p = {}, t = function (r, w) {
                var v = p[r];
                p[r] = Ha(w);
                if (!v) return !1;
                for (var y in w) if (w.hasOwnProperty(y) && w[y] !== v[y]) return !0;
                for (var x in v) if (v.hasOwnProperty(x) && v[x] !== w[x]) return !0;
                return !1
            }, q = function (r) {
                var w = r.vtp_trackingId, v = "https://www.google-analytics.com/analytics.js", y = Zd();
                if (ha(y)) {
                    var x = "gtag_" + w.split("-").join("_"), A = function (P) {
                        ...
                        if (N) {
                            var I = N.action;
                            if ("impressions" == I) P("ec:addImpression", N.Mf); else if ("promo_click" == I || "promo_view" == I) {
                                var J = N.Fc;
                                P("ec:addPromo", N.Fc);
                        ...
                        if (Oe()) {
                            ...
                            var P = qd(G.we, w);
                            P && (A("require", P, {dataLayer: "dataLayer"}), A("require", "render"))
                        }
                    }, E = function () {
                        if (Oe()) {
                        } else {
                            var P = qd(G.Xb, w), N = qd(G.Wb, w), I = qd(G.Vb, w), J;
                            J = ka(P) ? P : [P];
                    ...
                    (function () {
                        ...
                        y(function () {
                            if (Ga(P)) {
                                var N = F.X, I = Xd().getByName(x), J;
                                for (J in P) if (P.hasOwnProperty(J) && /^(dimension|metric)\d+$/.test(J) && void 0 != P[J]) {
                                    var O = I.get(k(P[J]));
                                    l(N, J, O)
                                }
                            }
                    ...
                    (function (P) {
                        if (P) {
                            var N = {};
                            if (Ga(P)) for (var I in e) e.hasOwnProperty(I) && h(e[I], I, P[I], N);
                            A("require", "linkid", N)
                        }
                    })(F.linkAttribution);
                    var Q = F[G.Ha];
                    ...
                    S == G.Mb ? (C(), A("send", "pageview", F.X)) : S == G.aa ? (C(), E(), 0 != F.sendPageView && A("send", "pageview", F.X)) : "screen_view" == S ? A("send", "screenview", F.X) : "timing_complete" == S ? (V("timingCategory", F.eventCategory,
    ...
    tj.Nf = function () {
        ...
        if (zc[yc.m]) {
            ...
            Ed = !1;
            Fd = 0;
            if ("interactive" == u.readyState && !u.createEventObject || "complete" == u.readyState) Hd(); else {
