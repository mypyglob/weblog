...
function handleHash_(o,v) {
    ...
    if(!optionStr){
        ...
        $.each(optionArr,function(i,itemStr){
            ...
            if(itemArr[0] == 'tel' || itemArr[0] == 'phone' || itemArr[0] == 'email' || itemArr[0] == 'website' || itemArr[0] == 'gwebsite' || itemArr[0] == 'mark' || itemArr[0] == 'patent' || itemArr[0] == 'finance' || itemArr[0] == 'listed' || itemArr[0] == 'shixin' || itemArr[0] == 'zzq' || itemArr[0] == 'rjzzq' || itemArr[0] == 'insured' || itemArr[0] == 'gxjs' || itemArr[0] == 'tender'){
                tel_email++;
            }
            if(itemArr[0] == 'startDate' || itemArr[0] == 'statusCode' || itemArr[0] == 'registfund' || itemArr[0] == 'coyType' || itemArr[0] == 'searchType'){
                other_sea++;
            }
    ...
    if(o == 'tel' || o == 'phone' || o == 'email' || o == 'website' || o == 'gwebsite' || o == 'mark' || o == 'patent' || o == 'finance' || o == 'listed' || o == 'shixin' || o == 'zzq' || o == 'rjzzq' || o == 'insured' || o == 'gxjs' || o == 'tender'){
        if(tel_email == 13){
...
function clearHash(obj, t){
    ...
    if(o == 'startDate' || o == 'statusCode' || o == 'registfund' || o == 'coyType' || o == 'searchType'){
...
function updateDesc(type){
    ...
    var hideFlag = true;//默认隐藏
    if(type == 1){
        var arr = ['index','searchType','coyType','statusCode','registfund','startDate','province','city','county','industrycode','subindustrycode','thirdindustrycode','tel','phone','email','website','gwebsite','mark','patent','finance','listed','shixin','zzq','rjzzq','insured','gxjs','tender'];
    }else if(type == 2){
    ...
    if($('.startDateChoose').is(':hidden') && $('.statusCodeChoose').is(':hidden') && $('.registfundChoose').is(':hidden')&& $('.searchTypeChoose').is(':hidden')&& $('.coyTypeChoose').is(':hidden')){
        $('#sotherOld').hide();
    }
...
function addSearchIndex(search_key,search_index,company_name) {
